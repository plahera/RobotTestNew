...
#include "Subsystems/CobraArmSystem.h"
#include "Subsystems/Drive.h"
#include "Subsystems/IntakeSubsystem.h"
#include "Subsystems/LifterSystem.h"
...
public:
    ...
    static std::shared_ptr<LifterSystem> lifterSystem;
    static std::shared_ptr<CobraArmSystem> cobraArmSystem;
